...
- [ ] Proof of passing tests and pipeline results attached to the PR description (screenshots for UI changes). See "PR Evidence Requirements" in `docs/architecture/sdlc.md`.
